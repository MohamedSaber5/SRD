...
export default function TopNavBar({ onMenuToggle }) {
  return (
    <nav className="bg-[#f7f9fb]/80 dark:bg-slate-950/80 backdrop-blur-lg text-[#001e40] dark:text-slate-100 font-['Tajawal'] font-bold text-lg leading-relaxed tracking-wide fixed top-0 w-full z-50 shadow-[0_1px_0_0_rgba(195,198,209,0.15)] shadow-sm md:hidden">
      <div className="flex flex-row-reverse justify-between items-center w-full px-4 py-4 max-w-full mx-auto">
        <div className="flex items-center flex-row-reverse gap-3">
          <button onClick={onMenuToggle} className="p-1 rounded-full hover:bg-black/5 dark:hover:bg-white/10 transition-colors flex items-center justify-center">
